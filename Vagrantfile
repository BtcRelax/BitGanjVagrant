...
config.vm.define "node1" do |node1|
  node1.vm.hostname = "www"
	...
	node1.vm.network "public_network",  bridge: "NVIDIA nForce Networking Controller", :mac=> "080027000001", ip: "192.168.0.102", hostname: true
...
config.vm.define "node2" do |node2|
  ...
  node2.vm.network "public_network",  bridge: "NVIDIA nForce Networking Controller", :mac=> "080027000002", ip: "192.168.0.103", hostname: true
...
config.vm.define "node3" do |node3|
  ...
  node3.vm.base_mac  = "080027000003"
	node3.vm.network "public_network",  bridge: "NVIDIA nForce Networking Controller", :mac=> "080027000003", ip: "192.168.0.104", hostname: true
